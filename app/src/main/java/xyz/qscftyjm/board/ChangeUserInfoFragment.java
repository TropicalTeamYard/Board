                ...
                if (cursor.moveToFirst()) {
                    if (cursor.getCount() > 0) {
                        ...
                        if (bitmap != null) {
                            ...
                            changeInfo.put("portrait", Objects.requireNonNull(BitmapIOUtil.bytesToHexString(baos.toByteArray())));
                        }
...
//                getCropImage();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == Activity.RESULT_OK && data != null) {
            ...
            Cursor c = getActivity().getContentResolver().query(Objects.requireNonNull(selectedImage), filePathColumns, null, null, null);
